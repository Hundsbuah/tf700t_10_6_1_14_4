...
int core_millivolts[] = { 950,     1000,     1050,     1300,     1350,     1375,     1412,     1437,   1462 };
...
static struct dvfs core_dvfs_table[] = {
   /* soc_id2 == TF201 && TF700T */
	/* Core voltages (mV):		  	        950,     1000,     1050,     1300,     1350,     1375,     1412,     1437,   1462  } */
	CORE_DVFS("cpu_lp",     2, 1, KHZ, 204000,   295000,   370000,   620000,   620000,   620000,   620000,   620000,   620000),
	CORE_DVFS("emc",        2, 1, KHZ, 102000,   450000,   450000,   800000,   900000,   900000,   900000,   900000,   900000),
	CORE_DVFS("sbus",       2, 1, KHZ, 102000,   205000,   205000,   334000,   334000,   334000,   334000,   334000,   334000),
	CORE_DVFS("vi",         2, 1, KHZ,      1,   219000,   267000,   425000,   425000,   425000,   425000,   425000,   425000),
	CORE_DVFS("vde",        2, 1, KHZ, 200000,   247000,   304000,   520000,   600000,   650000,   700000,   750000,   775000),
	CORE_DVFS("mpe",        2, 1, KHZ, 200000,   247000,   304000,   520000,   600000,   650000,   700000,   750000,   775000),
	CORE_DVFS("2d",         2, 1, KHZ, 200000,   267000,   304000,   520000,   600000,   650000,   700000,   750000,   775000),
	CORE_DVFS("epp",        2, 1, KHZ, 200000,   267000,   304000,   520000,   600000,   650000,   700000,   750000,   775000),
	CORE_DVFS("3d",         2, 1, KHZ, 200000,   247000,   304000,   520000,   600000,   650000,   700000,   750000,   775000),
	CORE_DVFS("3d2",        2, 1, KHZ, 200000,   247000,   304000,   520000,   600000,   650000,   700000,   750000,   775000),
	CORE_DVFS("se",         2, 1, KHZ, 200000,   267000,   304000,   520000,   600000,   650000,   700000,   750000,   775000),
	CORE_DVFS("host1x",     2, 1, KHZ, 100000,   152000,   188000,   267000,   300000,   325000,   350000,   350000,   350000),
	CORE_DVFS("cbus",       2, 1, KHZ, 200000,   247000,   304000,   520000,   600000,   650000,   700000,   750000,   775000),
	CORE_DVFS("pll_c",     -1, 1, KHZ, 533000,   667000,   667000,  1066000,  1200000,  1300000,  1400000,  1500000,  1550000),
	CORE_DVFS("mipi",       2, 1, KHZ,      1,        1,        1,    60000,    60000,    60000,    60000,    60000,    60000),
	CORE_DVFS("fuse_burn", -1, 1, KHZ,      1,        1,        1,    26000,    26000,    26000,    26000,    26000,    26000),
	CORE_DVFS("sdmmc1",    -1, 1, KHZ, 104000,   104000,   104000,   208000,   208000,   208000,   208000,   208000,   208000),
	CORE_DVFS("sdmmc3",    -1, 1, KHZ, 104000,   104000,   104000,   208000,   208000,   208000,   208000,   208000,   208000),
	CORE_DVFS("sdmmc4",    -1, 1, KHZ,  51000,   102000,   102000,   102000,   102000,   102000,   102000,   102000,   102000),
	CORE_DVFS("ndflash",   -1, 1, KHZ, 120000,   120000,   120000,   200000,   200000,   200000,   200000,   200000,   200000),
	CORE_DVFS("nor",        2, 1, KHZ, 102000,   115000,   130000,   133000,   133000,   133000,   133000,   133000,   133000),
	CORE_DVFS("sbc1",      -1, 1, KHZ,  36000,    52000,    60000,   100000,   100000,   100000,   100000,   100000,   100000),
	CORE_DVFS("sbc2",      -1, 1, KHZ,  36000,    52000,    60000,   100000,   100000,   100000,   100000,   100000,   100000),
	CORE_DVFS("sbc3",      -1, 1, KHZ,  36000,    52000,    60000,   100000,   100000,   100000,   100000,   100000,   100000),
	CORE_DVFS("sbc4",      -1, 1, KHZ,  36000,    52000,    60000,   100000,   100000,   100000,   100000,   100000,   100000),
	CORE_DVFS("sbc5",      -1, 1, KHZ,  36000,    52000,    60000,   100000,   100000,   100000,   100000,   100000,   100000),
	CORE_DVFS("sbc6",      -1, 1, KHZ,  36000,    52000,    60000,   100000,   100000,   100000,   100000,   100000,   100000),
   ...
   CORE_DVFS("pll_m",     -1, 1, KHZ, 533000,   667000,   667000,  1066000,  1066000,  1066000,  1066000,  1066000,  1066000),
#ifdef CONFIG_TEGRA_PLLM_RESTRICTED
	CORE_DVFS("pll_m",      2, 1, KHZ, 533000,   900000,   900000,  1066000,  1066000,  1066000,  1066000,  1066000,  1066000),
#endif
};
...
void static inline hundsbuah_set_dvfs_table_for_each_cpu_id_and_proc_id_individually(void)
{
	...
	if(cpu_speedo_id == 5) /* TF700T */
	{
		if(cpu_process_id == 3)
		{
		    ...
		    int millivolts_temp_array[] = {                                       750, 775, 800, 825, 850, 862,  900,  962,  975, 1000, 1012, 1025, 1050, 1062, 1075, 1100, 1112, 1125, 1150, 1175, 1200, 1212, 1237, 1275, 1350, 1387, 1400 };
		    struct dvfs cpu_dvfs_table_temp[]   = { CPU_DVFS("cpu_g",  5, 3, MHZ,   1,   1, 550, 550, 770, 770,  910,  910, 1150, 1230, 1230, 1280, 1330, 1330, 1370, 1400, 1400, 1470, 1500, 1500, 1540, 1540, 1700, 1750, 1800, 1850, 1900 ), };
			struct dvfs cpu_0_dvfs_table_temp[] = { CPU_DVFS("cpu_0",  5, 3, MHZ, 475, 620, 620, 760, 760, 910, 1000, 1150, 1150, 1150, 1300, 1300, 1300, 1400, 1400, 1400, 1500, 1500, 1500, 1600, 1600, 1600, 1700, 1750, 1800, 1850, 1900 ), };
		...
		{
			int millivolts_temp_array[] = {                                       750, 762, 775, 787, 800, 825, 837, 850,  875,  900,  925,  975,  987, 1000, 1025, 1050, 1062, 1075, 1100, 1112, 1125, 1150, 1200, 1212, 1275, 1350, 1387, 1400 };
