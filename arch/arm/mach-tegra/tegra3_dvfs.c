...
int user_mv_table[MAX_DVFS_FREQS] = {
		750, 762, 775, 787, 800, 825, 837, 850, 862, 875, 887, 900, 912, 916, 925, 937, 950, 962, 975, 987, 1000, 1007, 1012, 1025, 1037, 1050, 1062, 1075, 1087, 1100, 1112, 1125, 1137, 1150, 1162, 1175, 1187, 1200, 1212, 1237, 1275, 1350, 1400, 1425};
#endif
...
int core_millivolts[MAX_DVFS_FREQS] = {
	950,   1000,   1050,   1100,   1150,    1200,    1250,   1300, 1350,   1375,   1410,   1430,   1460 };
...
static int tegra3_get_core_floor_mv(int cpu_mv)
{
   ...
   if (cpu_mv < cpu_millivolts[33]) /* 1150 */
	   return  core_millivolts[10]; /* 1410 */
      
   if (cpu_mv < cpu_millivolts[36]) /* 1187 */
		return  core_millivolts[11]; /* 1430 */
      
   if (cpu_mv >= cpu_millivolts[36]) /* 1187 */
		return  core_millivolts[12];  /* 1460 */
...
static struct dvfs cpu_dvfs_table[] = {
   ...
   /* speedo_id 3 == TF201        750, 762, 775, 787, 800, 825, 837, 850, 862, 875, 887,  900,  912,  916,  925,  937,  950,  962,  975,  987, 1000, 1007, 1012, 1025, 1037, 1050, 1062, 1075, 1087, 1100, 1112, 1125, 1137, 1150, 1162, 1175, 1187, 1200, 1212, 1237, 1275, 1350, 1400, 1425}; */
	CPU_DVFS("cpu_g",  3, 1, MHZ,   1,   1,   1,   1, 480, 480, 480, 650, 650, 650, 650,  780,  780,  780,  780,  780,  780,  780,  990,  990, 1040, 1040, 1040, 1100, 1100, 1200, 1200, 1250, 1250, 1300, 1300, 1330, 1330, 1400, 1400, 1500, 1500, 1500, 1500, 1600, 1700, 1750, 1800),
	CPU_DVFS("cpu_g",  3, 2, MHZ,   1,   1,   1,   1, 520, 520, 520, 700, 700, 700, 700,  860,  860,  860,  860,  860,  860,  860, 1050, 1050, 1150, 1150, 1150, 1200, 1200, 1280, 1280, 1300, 1300, 1350, 1350, 1350, 1350, 1400, 1400, 1500, 1500, 1600, 1600, 1700, 1750, 1800),
	CPU_DVFS("cpu_g",  3, 3, MHZ,   1,   1,   1,   1, 550, 550, 550, 770, 770, 770, 770,  910,  910,  910,  910,  910,  910,  910, 1150, 1150, 1230, 1230, 1230, 1280, 1280, 1300, 1300, 1350, 1350, 1400, 1400, 1400, 1400, 1400, 1500, 1600, 1600, 1600, 1600, 1700, 1750, 1800),
